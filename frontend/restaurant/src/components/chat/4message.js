    ...
    <div className="flex flex-col">
      ...
      <div>
        ...
        <div className="py-2 max-w-screen-lg mx-auto">
          <h5 className="font-bold ml-1">Send A Message</h5>
          <ul className="overflow-auto" style={{height: "65vh",boxShadow:"0px 2px 3px 0.1px lightgrey"}}>
            {messages
              ?.sort((first, second) =>
            ...
            <div className="mb-6">
              <form id="message_sent_form"
                ...
                className="flex-row bg-gray-200 dark:bg-coolDark-400 px-1 py-1 z-10 max-w-screen-lg mx-auto dark:text-white shadow-md overflow-auto"
              >
                {/* <input
                  // ref={inputRef}
                  type="textarea"
                ...
                <div className="d-flex align-items-center float-right">
                  <label for="file-input" className="m-0">
