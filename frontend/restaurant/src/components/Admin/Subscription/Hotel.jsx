...
const Hotel = () => {
  const { isSidebarOpen, subcriptionplan } = useGlobalContext();
            ...
            <div className=" d-flex justify-content-center">
              <div className="container" style={{ backgroundColor: "white" }}>
                <ul className=" list-group list-group-flush">
                  ...
                  <li className="list-group-item">
                    <small>
                      Provides a Restaurant QR Code, Rooms QR Code & Table Qr
                      Code
                    </small>
                  </li>
                  <li className="list-group-item">
                    <small>
                      Best For Take Away and Dine in Restaurants and Hotels with
                      Rooms
                    </small>
                  </li>
                  <li className="list-group-item">
                  ...
                  <li className="list-group-item mb-3">
                    <button
                      ...
                      onClick={() => Razorpay("hotel", 3, 20000)}
                    >
                      {" "}
                ...
                <ul className=" list-group list-group-flush">
                  ...
                  <li className="list-group-item mb-3">
                    <button
                      ...
                      onClick={() => Razorpay("hotel", 6, 40000)}
                    >
                      {" "}
                      <h3 className="m-0 p-2">
                        <strong> Subscribe </strong>{" "}
                ...
                <ul className=" list-group list-group-flush">
                  ...
                  <li className="list-group-item mb-3">
                    <button
                      ...
                      onClick={() => Razorpay("hotel", 12, 80000)}
                    >
                      {" "}
                      <h3 className="m-0 p-2">
                        <strong> Subscribe </strong>{" "}
