            ...
            <div className=" d-flex justify-content-center">
              <div className="container" style={{ backgroundColor: "white" }}>
                <ul className=" list-group list-group-flush">
                  ...
                  <li className="list-group-item">
                    <small>Provides a Single QR Code</small>
                  </li>
                  <li className="list-group-item">
                    <small>Best For Take Away Restaurants</small>
                  </li>
                  <li className="list-group-item">
                  ...
                  <li className="list-group-item mb-3">
                    <button
                      ...
                      onClick={() => Razorpay("take_away", 3, 5000)}
                    >
                      {" "}
                ...
                <ul className=" list-group list-group-flush">
                  ...
                  <li className="list-group-item mb-3">
                    <button
                      ...
                      onClick={() => Razorpay("take_away", 6, 10000)}
                    >
                      {" "}
                      <h3 className="m-0 p-2">
                        <strong> Subscribe </strong>{" "}
                ...
                <ul className=" list-group list-group-flush">
                  ...
                  <li className="list-group-item mb-3">
                    <button
                      ...
                      onClick={() => Razorpay("take_away", 12, 20000)}
                    >
                      {" "}
                      <h3 className="m-0 p-2">
                        <strong> Subscribe </strong>{" "}
