                          ...
                          <div className="items-center mb-1">
                            ...
                            {messages.createdAt?.seconds ? (
                              <span
                                ...
                                style={ messages.sender === "admin" ? {width:'100%',textAlign:"end"}: {width: '100%', textAlign: 'start', float: 'left'}}
                              >
                                {formatDate(
              ...
              <form onSubmit={handleSubmit(OnSubmit)}>
                <div class="wrap">
                  ...
                  <textarea
                    ...
                    {...register("text")}
                  />
<div className="d-flex align-items-center float-right" style={{marginRight: "1.5%"}}>
